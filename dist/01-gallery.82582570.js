...
var _simpleLightboxMin = _interopRequireDefault(require("simplelightbox/dist/simple-lightbox.min.css"));
...
var galleryDivRef = document.querySelector(".gallery");

var createImageGrid = function createImageGrid() {
  var markup = _galleryItems.galleryItems.map(function (item) {
    var smallImage = item.preview,
        largeImage = item.original,
        description = item.description;
    return "\n                <a onclick=\"return false\" class=\"gallery__link\" href=\"".concat(largeImage, "\">\n                    <img\n                    class=\"gallery__image\"\n                    src=\"").concat(smallImage, "\"\n                    alt=\"").concat(description, "\"\n                    captionSelector = \"1000\"\n                    />\n                </a> \n                    ");
  }).join("");
